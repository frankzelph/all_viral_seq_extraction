...
#rm -rf cov_figs
if [ ! -d "bn_cov_figs" ]; then
    mkdir "bn_cov_figs"
fi

python ../coverage.py "blastout/${file}.bn6" "${file}.stat" $threshold $query_seqfile bn_cov_figs
...
python ../extract_seq.py ../${file}.fasta blastout/${file}.bn6 ${file}.stat $threshold bn_seqs
